            ...
            <form action="{{ route('register_company') }}" method="POST">
                ...
                <div class="d-flex flex-column">
                    <div class="form-floating mb-3 w-25 mx-auto">
                        <input type="text" name="name" id="name" class="form-control" placeholder="Nazwa firmy" value="{{ old('name') }}">
                        <label for="name" class="align-self-start">Nazwa firmy</label>
                        @error('name')
                    ...
                    <div class="form-floating mb-3 w-25 mx-auto">
                        <input type="text" name="nip" id="nip" class="form-control w-100" placeholder="NIP" value="{{ old('nip') }}">
                        <label for="nip" class="align-self-start">NIP</label>
                        @error('date')
                        <div class="text-danger mt-1">{{ $message }}</div>
                        @enderror
                    </div>
